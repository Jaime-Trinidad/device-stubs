...
if(options.template === 'index'){
    generateTemplateFiles([
        ...
        
        {
            ...
            output: {
                path: './new_device/__index__(lowerCase).yaml',
    ...
    generateTemplateFiles([
        {
            ...
            output: {
                path: './new_device/__model__(lowerCase).yaml',
                pathAndFileNameDefaultCase: '(kebabCase)',
            },
        }, 
    ]);
    ...
    generateTemplateFiles([
        {
            ...
            output: {
                path: './new_device/__profile__(lowerCase)-profile.yaml',
                pathAndFileNameDefaultCase: '(kebabCase)',
            },
        }, 
    ]);
    ...
    generateTemplateFiles([
        {
            ...
            output: {
                path: './new_device/__codec__(lowerCase)-codec.yaml',
                pathAndFileNameDefaultCase: '(kebabCase)',
            },
        }, 
    ]);
